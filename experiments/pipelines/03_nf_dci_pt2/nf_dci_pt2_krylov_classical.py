"""NF + DCI + PT2 -> Classical Krylov pipeline.
...
Pipeline:
  ...
  4. Classical Krylov subspace diagonalization (SKQD)
...
configurations, adding perturbatively significant determinants before
the final Krylov diagonalization.
"""
...
def main() -> None:
    ...
    # Inject expanded basis back into pipeline for Krylov
    pipeline._essential_configs = basis.to(device)  # noqa: SLF001
    pipeline.nf_basis = basis
    ...
    # --- Results summary ---
    print("\n" + "=" * 60)
    print("NF + DCI + PT2 -> CLASSICAL KRYLOV RESULTS")
    print("=" * 60)
