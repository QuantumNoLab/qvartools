"""Pipeline 04a: NF-only basis -> Classical Krylov (no Direct-CI merge).
...
def main() -> None:
    ...
    parser = create_base_parser(
        "Pipeline 04a: NF-only basis -> Classical Krylov (no Direct-CI).",
    )
    ...
    # --- Results summary ---
    print("\n" + "=" * 60)
    print("PIPELINE 04a: NF-ONLY -> CLASSICAL KRYLOV RESULTS (no Direct-CI)")
    print("=" * 60)
