"""N2-40Q HF v4 benchmark: GPU sparse_det + GPU coupling.

16 tasks: 3 variants x budgets, push to smaller N_det to find precision floor
and measure GPU speedup vs v3.
"""
import argparse
import json
import time
...
def main():
    ...
    print(f"\n{'='*90}")
    print(f"  FINAL v4 ({args.variant} @ {args.budget})")
