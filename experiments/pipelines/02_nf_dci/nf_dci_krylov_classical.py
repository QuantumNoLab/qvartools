"""Pipeline 02a: NF + Direct-CI merged basis -> Classical Krylov.
...
Runs the 3-stage pipeline:
  ...
  3. SKQD Krylov subspace diagonalization (classical)
...
def main() -> None:
    ...
    parser = create_base_parser(
        "Pipeline 02a: NF + Direct-CI -> Classical Krylov.",
    )
    ...
    # --- Results summary ---
    print("\n" + "=" * 60)
    print("PIPELINE 02a: NF + DCI -> CLASSICAL KRYLOV RESULTS")
    print("=" * 60)
