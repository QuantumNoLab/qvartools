...
def load_sci_energy(geometry, basis: str, charge: int, spin: int) -> Optional[dict]:
...
def save_sci_energy(
    geometry, basis: str, charge: int, spin: int,
    energy: float, basis_size: int = 0, wall_time: float = 0.0,
) -> None:
...
def load_reference_energy(name: str, method: str = "sci") -> Optional[dict]:
...
def save_reference_energy(
    name: str, method: str, energy: float,
    basis_size: int = 0, wall_time: float = 0.0,
) -> None:
